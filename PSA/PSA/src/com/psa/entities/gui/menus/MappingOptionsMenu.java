...
public class MappingOptionsMenu extends ContextMenu {
	...
	private MappingOptionsMenu( TreeItem< String > treeItem ) {
		...
		getItems().addAll( openItem , closeItem , SeparatorMenuItemBuilder.create().build() , deleteItem , backupItem , restoreItem , SeparatorMenuItemBuilder.create().build() , renameItem , saveItem , execItem );
	}
