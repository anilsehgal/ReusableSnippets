...
import com.psa.entities.gui.controls.UtilityStack;
...
public class MapperApplication extends Application {
	...
	public void start(final Stage primaryStage) {
		 ...
		 StackPane stackPaneUtilityStack = initControlStack( UtilityStack.getInstance(), LEFT_TREE_WIDTH );
		 
		 SplitPane utilSplitPane = new SplitPane();
		 utilSplitPane.setOrientation(Orientation.VERTICAL);
		 utilSplitPane.setMinWidth( LEFT_TREE_WIDTH );       
		 utilSplitPane.setMaxWidth( LEFT_TREE_WIDTH );
		 ...
		 utilSplitPane.getItems().addAll( stackPaneMappingTree, stackPaneUtilityStack );
		 componentSplitPane.getItems().addAll( stackPaneBaseView , stackPaneTransformation );

		 mainSplitPane.getItems().addAll( utilSplitPane , PSADesigner.getInstance() , componentSplitPane );
